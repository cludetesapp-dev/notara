    ...
    <div>
      ...
      {report.loading ? (
        ...
        <>
          ...
          <div style={{ background:'#fff', borderRadius:'var(--r-lg)', border:'1.5px solid #e8f0e8', padding:'14px 14px 10px', marginBottom:10 }}>
              ...
              <div style={{ height:150 }}>
                <ResponsiveContainer width="100%" height="100%">
                  <BarChart data={report.months} barCategoryGap="28%" barGap={2}>
                    ...
                    <Bar dataKey="omset"  fill="#4ade80" radius={[3,3,0,0]} name="omset" />
                    <Bar dataKey="profit" fill="#166534" radius={[3,3,0,0]} name="profit" />
                  </BarChart>
                </ResponsiveContainer>
              </div>
            )}
          ...
          {/* Tabel bulanan */}
          <div style={{ background:'#fff', borderRadius:'var(--r-lg)', border:'1.5px solid #e8f0e8', overflow:'hidden', marginBottom:10 }}>
            ...
            <div style={{
              ...
              padding:'6px 14px', background:'#f8faf8',
