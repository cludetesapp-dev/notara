      ...
      <div style={{ marginBottom: 10 }}>
        <input
          ...
          style={{
            ...
            borderRadius: 'var(--r)', border: '1.5px solid #e8f0e8',
      ...
      {report.loading ? (
        ...
        <>
          ...
          <div style={{ display:'grid', gridTemplateColumns:'1fr 1fr', gap:8, marginBottom:10 }}>
            <SummCard label="Omset" value={formatRupiahCompact(report.omset)} color="var(--green)" bg="#f0fdf4" border="#bbf7d0" />
            <SummCard label="Laba" value={formatRupiahCompact(report.profit)} color="var(--green)" bg="#f0fdf4" border="#bbf7d0" />
            <SummCard label="Pembelian" value={formatRupiahCompact(report.purchase)} color="var(--amber)" bg="#fffbeb" border="#fde68a" />
            <SummCard label="Transaksi" value={`${report.txCount} nota`} color="var(--clay)" bg="#fafaf9" border="#e8f0e8" mono={false} />
          </div>
          ...
          {report.transactions.length === 0 ? (
            ...
            <div style={{
              background: '#fff', borderRadius: 'var(--r-lg)',
              border: '1.5px solid #e8f0e8', overflow: 'hidden',
            }}>
                  ...
                  <div key={tx.id} style={{
                    ...
                    <div style={{
                      ...
                      {isSale
                        ...
                        : <ArrowDownLeft size={15} color="var(--amber)" />
                      }
                    </div>
